...
is not used for computing, only in a limited fashion for graphics rendering.
...
Have you ever been to Holland? It is the most bicycle friendly country in the world. Imagine that you 
...
\begin{bbox}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{add\PYZus{}database\PYZus{}entry}\PY{p}{(}\PY{l+s}{"}\PY{l+s}{Lance}\PY{l+s}{"}\PY{p}{,} \PY{l+s}{"}\PY{l+s}{Armstrong}\PY{l+s}{"}\PY{p}{,} \PY{l+s}{"}\PY{l+s}{bicycle}\PY{l+s}{"}\PY{p}{)}
\end{Verbatim}
\end{bbox}
\vspace{6mm}
...
type {\tt "bicycle"} for Lance Armstrong or any other bicyclist:\\

\begin{bbox}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{enter}\PY{p}{(}\PY{l+s}{"}\PY{l+s}{Lance}\PY{l+s}{"}\PY{p}{,} \PY{l+s}{"}\PY{l+s}{Armstrong}\PY{l+s}{"}\PY{p}{)}
\end{Verbatim}
\end{bbox}
\vspace{6mm}
...
\end{center}
\vspace{-4mm}
\caption{Setting plot limits on the horizontal axis to $0$ and $2\pi$.}
\label{fig:plot9}
\vspace{-2mm}
\end{figure}
\noindent
...
like this makes Python programming very flezible. However, we should not abuse our 
...
\begin{ybox}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{p}{(}\PY{l+s}{'}\PY{l+s}{March}\PY{l+s}{'}\PY{p}{,} \PY{l+s}{'}\PY{l+s}{April}\PY{l+s}{'}\PY{p}{,} \PY{l+s}{'}\PY{l+s}{May}\PY{l+s}{'}\PY{p}{)}
\end{Verbatim}
\end{ybox}
\vspace{6mm}
...
raise exceptions on our won. So far we have seen {\tt ZeroDivisionError},
